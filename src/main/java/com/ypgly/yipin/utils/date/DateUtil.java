package com.ypgly.yipin.utils.date;
...
public class DateUtil {
    ...
    private static final DateTimeFormatter yyyyMMddHHmmsssss_EN = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss SSS");
    /** HH:mm:ss */
     ...
     * 获取当前日期
     *
     * @return 字符串yyyy-MM-dd HH:mm:ss sss
     *
     */
    public static String getNowTimeTemp_EN() {
        return LocalDateTime.now().format(yyyyMMddHHmmsssss_EN);
    }
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("===================");
        /*System.out.println(getTime("yy"));
        System.out.println(getTime("MM"));
        System.out.println(getTime("dd"));
        String fileName="1592549633224_en_zh.txt";
        String fileEnd = fileName.substring(fileName.lastIndexOf("."));
        System.out.println("fileEnd:"+fileEnd);*/
        System.out.println(getNowTimeTemp_EN());
    }
